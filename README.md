...
Right now I'm working on Inception project.

### 📊 42 Project

Most of these projects were developed as part of the 42 curriculum, and they cover a wide range of low-level programming concepts — from threading and memory management to graphics and shell design. All built in C and C++ and tested on Linux/macOS.

| 🧠 Project     | 📝 Description                                                                                       | 🔗 Link |
|----------------|------------------------------------------------------------------------------------------------------|---------|
| 💬`ft_irc`     |An IRC (Internet Relay Chat) server written in C++. Implements core IRC protocol features such as client connections, channels, messaging, operator commands, and authentication. Focused on socket programming, networking, and protocol design.|[ft_irc](https://github.com/mfortuna23/ft_irc) |
| 🧩`CPP modules`|A collection of C++ projects designed to introduce and deepen understanding of modern C++. Covers object-oriented programming, inheritance, polymorphism, templates, exceptions, STL containers, and memory management through progressive exercises.|[CPP Modules](https://github.com/mfortuna23/cpp) |
